...
public class eightball2 extends CommandBase {
  /**
  ...
  public eightball2() throws IOException {
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(RobotContainer.driveSub);
    
    exampleTrajectory = TrajectoryUtil.fromPathweaverJson(Paths.get("/home/lvuser/deploy/output/eightball2.wpilib.json"));
