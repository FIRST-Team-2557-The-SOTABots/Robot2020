...
public class fiveball1 extends CommandBase {
  Trajectory exampleTrajectory;
  RamseteCommand gordonRamsete;
  public static double commandTime = 0;

  public fiveball1() throws IOException {
    addRequirements(RobotContainer.driveSub);
    
    exampleTrajectory = TrajectoryUtil.fromPathweaverJson(Paths.get("/home/lvuser/deploy/output/fiveball1.wpilib.json"));
